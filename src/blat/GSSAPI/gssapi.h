...
#if defined(__STDC__) || defined(__cplusplus) || defined(_MSDOS) || defined(_WIN32) || defined(_WIN64) || defined(__ultrix)
...
/*
 * $Id: gssapi.hin,v 1.1.1.2 2002/09/25 17:38:58 pbh Exp $
 */
 ...
 */
#define GSS_C_DELEG_FLAG      (1 << 0)
#define GSS_C_MUTUAL_FLAG     (1 << 1)
#define GSS_C_REPLAY_FLAG     (1 << 2)
#define GSS_C_SEQUENCE_FLAG   (1 << 3)
#define GSS_C_CONF_FLAG       (1 << 4)
#define GSS_C_INTEG_FLAG      (1 << 5)
#define GSS_C_ANON_FLAG       (1 << 6)
#define GSS_C_PROT_READY_FLAG (1 << 7)
#define GSS_C_TRANS_FLAG      (1 << 8)
